...
void _saveCandles(String dir, String symbol, DateTime start, DateTime end, List<Map<String, dynamic>> candles) {
  ...
  final startS = '${start.year}${start.month.toString().padLeft(2,'0')}${start.day.toString().padLeft(2,'0')}';
  final endS = '${end.year}${end.month.toString().padLeft(2,'0')}${end.day.toString().padLeft(2,'0')}';
  File('$dir\\candle_${symbol}_${startS}${endS}_1d.json').writeAsStringSync(jsonEncode(candles));
}
